 ...
 */
package cn.finalteam.mygallery.widget.zoonview;
...
public interface IPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(cn.finalteam.mygallery.widget.zoonview.PhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(cn.finalteam.mygallery.widget.zoonview.PhotoViewAttacher.OnPhotoTapListener listener);
     ...
     */
    cn.finalteam.mygallery.widget.zoonview.PhotoViewAttacher.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(cn.finalteam.mygallery.widget.zoonview.PhotoViewAttacher.OnViewTapListener listener);
     ...
     */
    cn.finalteam.mygallery.widget.zoonview.PhotoViewAttacher.OnViewTapListener getOnViewTapListener();
     ...
     */
    void setOnScaleChangeListener(cn.finalteam.mygallery.widget.zoonview.PhotoViewAttacher.OnScaleChangeListener onScaleChangeListener);
}
