...
import cn.finalteam.mygallery.PhotoEditActivity;
...
public class PhotoEditListAdapter extends ViewHolderAdapter<PhotoEditListAdapter.ViewHolder, PhotoInfo> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = inflate(R.layout.my_gf_adapter_edit_list, parent);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mIvPhoto.setImageResource(R.drawable.photo_default_bg);
