        ...
        if (message.direct() == Direct.SEND) {
            try {
                if (!TextUtils.isEmpty(message.getStringAttribute("nickName"))) {
                    //EaseUserUtils.setUserAvatar(context, message.getStringAttribute("nickName"), userAvatarView);
                    userAvatarView.setBackgroundColor(message.getFrom());
                    userAvatarView.setText(message.getStringAttribute("nickName"));
                }
