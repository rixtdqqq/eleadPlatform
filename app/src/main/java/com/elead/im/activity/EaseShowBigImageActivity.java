...
import com.elead.im.util.EaseLoadLocalBigImgTask;
import com.elead.im.widget.photoview.EasePhotoView;
...
public class EaseShowBigImageActivity extends EaseBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        default_res = getIntent().getIntExtra("default_image", R.drawable.ic_launcher);
