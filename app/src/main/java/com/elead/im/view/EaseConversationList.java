...
import com.elead.im.adapter.EaseConversationAdapter;
...
public class EaseConversationList extends ListView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        primaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListPrimaryTextColor, ContextCompat.getColor(context,R.color.chengse));
        secondaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListSecondaryTextColor, ContextCompat.getColor(context,R.color.chengse));
        timeColor = ta.getColor(R.styleable.EaseConversationList_cvsListTimeTextColor, ContextCompat.getColor(context,R.color.chengse));
    ...
    public void refresh() {
    	if(null != handler && !handler.hasMessages(MSG_REFRESH_ADAPTER_DATA)){
