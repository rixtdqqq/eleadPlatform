...
public class PoOperationList extends LinearLayout implements View.OnClickListener, AbsListView.OnScrollListener {
    ...
    public PoOperationList(Context context) {
        this(context, null);
    }

    public PoOperationList(Context context, AttributeSet attrs) {
...
//    }
    ...
    public PoOperationList(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initViews() {
        ...
        ll.setOnClickListener(PoOperationList.this);
        // changeButtonStatus();
        listiv.setOnScrollListener(PoOperationList.this);
