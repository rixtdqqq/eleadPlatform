...
public class PopuJar extends PopupWindows implements OnDismissListener {
    ...
    public void setBackGrouned(int resid) {
        // TODO Auto-generated method stub
        mScroller.setBackgroundResource(resid);
    }
    ...
    public void addPopuItem(PopuItem action) {
        ...
        int size = action.getTextSize();
        int color = action.getTextColor();
        View container;

        container = mInflater.inflate(R.layout.action_item, null);

        TextView text = (TextView) container.findViewById(R.id.title);
       // View line_vi=(View)container.findViewById(R.id.line_vi);

        if (icon != null) {
            setTextDraw(mContext, text, icon, Gravity.LEFT);
        }
        ...
        Log.i("TAGL", "orientation=" + mOrientation + "mChildPos===" + mChildPos);
    ...
    private void setTextDraw(Context context, TextView titleTv,
                             Drawable drawable, int gravity) {
        try {
            drawable.setBounds(0, 0, drawable.getMinimumWidth(),
                    drawable.getMinimumHeight());
            final float scale = context.getResources().getDisplayMetrics().density;
            titleTv.setCompoundDrawablePadding((int) (13 * scale + 0.5f));
    ...
    public void show(View anchor) {
        ...
        Rect anchorRect = new Rect(location[0] + anchor.getWidth(), location[1], location[0]
                , location[1] + anchor.getHeight() / 2);
        ...
        ;
        mWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, xPos, (int) (yPos + mContext.getResources().getDisplayMetrics().density * 8));
    }
...
//        }
    ...
    public void setBackground(int menu_dropdown_panel) {
        mTrack.setBackground(mContext.getResources().getDrawable(menu_dropdown_panel));
    }
    ...
    public void setMarginT(boolean flags) {
        this.flags = flags;
    }
}