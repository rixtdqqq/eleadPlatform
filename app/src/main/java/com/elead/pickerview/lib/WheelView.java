package com.elead.pickerview.lib;
...
import com.elead.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    boolean customTextSize=false;//自定义文字大小，为true则用于使setTextSize函数无效，只能通过xml修改
    int maxTextWidth;
    int maxTextHeight;
    ...
    // 条目间距倍数
    static final float lineSpacingMultiplier = 1.9F;
    boolean isLoop;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.fontcolors8);
        textColorCenter = getResources().getColor(R.color.fontcolors8);
        dividerColor = getResources().getColor(R.color.fontcolors8);
