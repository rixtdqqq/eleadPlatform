 ...
 * method that you implemented for {@link com.com.huawei.hr.affairs.rbs.widget.PercentLayoutHelper.PercentLayoutParams} interfaces.
 * <li> Override
...
public class PercentLayoutHelper {
    ...
    /**
     * Iterates over children and changes their width and height to drfault calculated from percentage
     * values.
     *
     ...
     *
     * @return True if the measure phase needs to be rerun because drfault of the children would like
     ...
     * {@code LayoutParams} subclass must implement this interfaces.
     * <p/>
     * Your {@code LayoutParams} subclass should contain an instance of {@code PercentLayoutInfo}
     * and the implementation of this interfaces should be a simple accessor.
     */
