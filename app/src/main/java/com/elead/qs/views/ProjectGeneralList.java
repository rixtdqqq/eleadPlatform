...
import com.gly.zpower.baseadapter.CommonAdapter;
import com.gly.zpower.baseadapter.ViewHolder;
...
public class ProjectGeneralList extends LinearLayout implements View.OnClickListener, AbsListView.OnScrollListener {

    private LinearLayout ll;
    private Context mContext;
    private String Toptitle[] = {"iCaptain for mobile in the HR", "知识云_MTL颗粒2016产品版本V02nn", "华为人才社区IHUAWEI二期需求V02BBB", "iCaptain for mobile in the HR", "云朵云_MTL颗粒2016产品版本V02nn", "华为人才社区IHUAWEI二期需求V02BBB", "云朵云_MTL颗粒2016产品版本V02nn"};
    private String unit[] = {"移动业务单元", "移动业务单元", "移动业务单元", "移动业务单元", "移动业务单元", "移动业务单元", "综合业务单元"};
    private String progress[] = {"上周质量评分:62.4分 SAI值:8.5 缺陷数:1 \n事件量:3 指标2:8.5  指标3:1", "上周质量评分:62.4分 SAI值:8.5 缺陷数:1 \n事件量:3 指标2:8.5  指标3:1", "上周质量评分:62.4分 SAI值:8.5 缺陷数:1 ", "待验收审核", "待验收审核", "代付款", "代付款"};
    ...
    private int index = 0;
    public CommonAdapter<PoPreViewEnty> adapter;
    ...
    public ProjectGeneralList(Context context) {
        this(context, null);
    }

    public ProjectGeneralList(Context context, AttributeSet attrs) {
...
//    }
    ...
    public ProjectGeneralList(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initViews() {
        ...
        // Log.i("TAG","tpee"+type);
        adapter = new CommonAdapter<PoPreViewEnty>(mContext, list, R.layout.card_po_preview_item) {
            @Override
            public void convert(ViewHolder helper, PoPreViewEnty item) {
                helper.setText(R.id.title_top_iv, item.getTopTitle());
                helper.setText(R.id.title_bottom_iv, item.getBottomTime());
                helper.setImageResource(R.id.imgres_ig, item.getImgSrc());
            }
        };
        ...
        ll.setOnClickListener(ProjectGeneralList.this);
        // changeButtonStatus();
        listiv.setOnScrollListener(ProjectGeneralList.this);
